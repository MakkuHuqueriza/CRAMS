...
export default function SignupPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
      ...
      {/* Right Section */}
      <div className="bg-white flex flex-col justify-center items-center p-4 sm:p-6 md:p-8 lg:w-1/2 w-full rounded-t-[30px] md:rounded-none md:h-auto absolute bottom-0 md:relative">
        ...
        <input
          ...
          onBlur={() => setShowReenterPassword(!!password)}
          className="bg-[#f5f9fc] border-[1px] border-[#B9B9B9] rounded-md p-1 md:p-2 w-[80%] sm:w-[70%] md:w-[60%] mb-4 text-sm"
        />
        {showReenterPassword && (
          <>
        ...
        <button
          ...
          className="bg-[#9BB2FC] text-black font-medium text-[12px] sm:text-[13px] lg:text-[16px] px-6 sm:px-8 py-[6px] rounded-[50px] mt-4 transition hover:scale-[103%]"
        >
          Create Account
        </button>
