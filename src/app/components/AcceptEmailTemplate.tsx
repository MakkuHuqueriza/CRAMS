...
const AcceptEmailTemplate: React.FC<EmailReservationSummaryProps> = ({
  reservation,
}) => (
  <div>
    ...
    <p>
      Please arrive on time and bring any necessary documents or identification.
      If you have questions, contact the admin.
    </p>
  </div>
);
