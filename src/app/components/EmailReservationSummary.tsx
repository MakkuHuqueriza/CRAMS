...
export const EmailTemplate: React.FC<EmailReservationSummaryProps> = ({
  ...
  <div>
    ...
    <ul>
      ...
      <li>
        <strong>Course/Department:</strong> {course}
      </li>
      <li>
      ...
      <li>
        <strong>Nature of Work:</strong> {nature_of_work}
      </li>
      {others_purpose && (
        <li>
          <strong>Other Purpose:</strong> {others_purpose}
        </li>
      )}
    </ul>
    <p>
      Please wait for an email confirmation if your reservation is accepted or
      not
    </p>
  </div>
);
