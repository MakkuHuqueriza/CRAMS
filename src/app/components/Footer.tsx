      ...
      <div className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col space-y-4 pl-4 mb-2 md:mb-0">
            ...
            <span className="font-semibold">don{"'"}t stress, just CRAMS.</span>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 flex flex-col items-center">
              <li>
                <Link
                  href="/"
                  className="text-gray-200 hover:text-white hover:font-medium hover:underline underline-offset-4 decoration-1 hover:decoration-white transition-all duration-200 text-left w-fit"
                >
                  Available Rooms
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 flex flex-col items-center">
              ...
              <li className="flex items-center space-x-3 cursor-default">
                ...
                <span className="text-gray-200">Mon-Fri: 8AM - 5PM</span>
              </li>
            </ul>
          </div>
        </div>
