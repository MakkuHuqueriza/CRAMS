...
export const SearchLoadingState = ({ isLoading }: SearchLoadingStateProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-8 shadow-2xl flex flex-col items-center gap-6 max-w-sm mx-4 min-w-[320px]">
        ...
        <div className="text-center space-y-3">
          <h3 className="text-xl font-bold text-[#274c77]">Searching Rooms</h3>
          <p className="text-sm text-gray-600 animate-pulse min-h-[20px]">{loadingText}</p>
        </div>
